    ...
    return(
        <>
            ...
            <div className="container">
                <WorkStyles>
                    <div>
                    <iframe src="https://player.vimeo.com/video/69589123" width="100%" height="480" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div className="work-text">
                        <h2>Five Fine Fillies</h2>
